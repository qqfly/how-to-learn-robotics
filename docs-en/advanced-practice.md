...
- Mobility: mainly about the control of legged robots. On one hand, it gives you a rough sense of
  ...
  simplified model can still be a huge help for control, which incidentally lays the groundwork for
  the reinforcement-learning motion control in the Embodied AI part.
...
1. **Orientation-interpolation experiment** (maps to Modern Robotics, Application 1): implement
   ...
   and plot how the angular-velocity direction changes over time. You'll see with your own eyes
   that "straight-line interpolation jumps at the transition point, while the Bezier blend is
   continuous."
...
By now, you can already read most of the latest papers. So you should follow conferences like RSS,
ICRA, and IROS to keep up with the latest progress in robotics, and learn the latest theory
through journals like IJRR and TRO.
