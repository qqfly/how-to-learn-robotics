...
| 8   | 进阶 · 3D 视觉      | [docs/3d-vision.md](docs/3d-vision.md)                 |
| 9   | 进阶 · 自主规划     | [docs/motion-planning.md](docs/motion-planning.md)     |
| 10  | 进阶 · 进阶实践     | [docs/advanced-practice.md](docs/advanced-practice.md) |
| 11  | 具身智能（整理中）  | [docs/embodied-ai.md](docs/embodied-ai.md)             |
| 12  | 勇者斗恶龙          | [docs/dragon-quest.md](docs/dragon-quest.md)           |
| 13  | 参考文献            | [docs/references.md](docs/references.md)               |
| 14  | 版权说明            | [docs/license.md](docs/license.md)                     |

## 适合谁

面向希望系统自学机器人学的工科背景读者（如机电、自动化、计算机等专业的学生或工程师），尤其是缺乏完整机器人学训练、需要一条清晰学习路径的「非科班出身」读者。
...
本作品采用 [知识共享署名 4.0 国际许可协议 (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/) 进行许可，详见 [LICENSE.md](LICENSE.md)。
